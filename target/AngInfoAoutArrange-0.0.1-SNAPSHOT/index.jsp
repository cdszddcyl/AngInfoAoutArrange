	...
	$.ajax({
		   ...
		   success: function(msg){
		     ...
		     if(msg.statusCode!=200){
		    	 ...
		    	 setTimeout(function(){
		    		 window.location.href="${rootPath}"+msg.data;
		    	 }, 1000);
		     }
		   }
		});
	...
	<div id="myCarousel" class="carousel slide">
		...
		<div class="carousel-inner">
			<div class="item active">
				<img style="width: 1366px; height: 605px;" src="${rootPath}/images/1-27.jpg"
					alt="First slide">
			</div>
			<div class="item">
				<img style="width: 1366px; height: 605px;" src="${rootPath}/images/1-28.jpg"
					alt="Second slide">
			</div>
		</div>
	</div>
